...
<head>
    ...
    <title>Publish Advanced Diploma Results</title>
...
<div class="container mt-5">
    <div class="button-box mb-4" style="border: 1px solid #ddd; border-radius: 10px; padding: 20px; background-color: #f8f9fa;">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <!-- Select Module -->
           <form method="GET" action="{{ route('Advanced_Diploma_publish') }}" id="moduleForm" >
   ...
   <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('confirmPublish').onclick = function () {
                ...
                const baseUrl = "{{ route($isPublished ? 'advanced_diploma.unpublish' : 'advanced_diploma.publish') }}";
