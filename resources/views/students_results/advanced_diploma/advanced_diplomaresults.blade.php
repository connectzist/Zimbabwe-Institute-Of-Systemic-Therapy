...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Advanced Diploma Students Results</h4>

         <!-- Upload Button -->
         <div class="d-flex justify-content-end mt-3">
            <form action="{{ url('/ad_upload') }}" method="get">
                ...
                <tbody>
                    @foreach($studentsData as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('students_results.advanced_diploma.advanced_diploma_view', $data['id']) }}" class="btn btn-info btn-sm">View</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
